...
public class AvaliacaoAMQPConfiguration {
    ...
    @Bean
    public Queue queuePagamentoDetalhe() {
        return QueueBuilder
    ...
    @Bean
    public Queue queueDlqPagamentoDetalhe() {
        return QueueBuilder.nonDurable("pagamentos.detalhes-avaliacao.dlq").build();
    }
    @Bean
    public FanoutExchange pagamentoExchange() {
        return ExchangeBuilder
                .fanoutExchange("pagamentos.ex")
                .build();
    }
    @Bean
    public FanoutExchange dlxPagamentoExchange() {
        return ExchangeBuilder
    ...
    public Binding bindingPagamentoPedido() {
        return BindingBuilder.bind(queuePagamentoDetalhe()).to(pagamentoExchange());
    }
    @Bean
    public Binding bindingDlxPagamentoPedido() {
        return BindingBuilder.bind(queueDlqPagamentoDetalhe()).to(dlxPagamentoExchange());
    }
